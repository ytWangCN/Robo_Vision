...
int main(int argc, char **argv)
{
    ...
    int flags = 0;
    unique_ptr<VideoCapture> capture(new RMVideoCapture());
    // capture->set(CAP_PROP_EXPOSURE, 100); //工业//
    // capture->set(CAP_PROP_GAIN, 10);
    bool flipVertical;
